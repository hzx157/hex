...
+ (void)get:(NSString *)url withParams:(NSDictionary *)parameters completionBlock:(void (^)(id))success failureBlock:(void (^)(NSError * error,NSString * responseString))failure
{
...
- (void)get:(NSString *)url withParams:(NSDictionary *)parameters completionBlock:(void (^)(id obj))success failureBlock:(void (^)(NSError * error,NSString * responseString))failure
{
...
- (void)post:(NSString *)url withParams:(NSDictionary *)params completionBlock:(void (^)(id obj))success failureBlock:(void (^)(NSError * error,NSString * responseString))failure
{
    ...
    [_manager POST:[[self class] urlEncode:url] parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(success){
            success(responseObject);
            if(responseObject&&![[responseObject objectForKey:@"Error"]isKindOfClass:[NSNull class]]&&[[responseObject objectForKey:@"Error"] isEqualToString:@"参数不正确,访问不到数据,请重新登录"]){
