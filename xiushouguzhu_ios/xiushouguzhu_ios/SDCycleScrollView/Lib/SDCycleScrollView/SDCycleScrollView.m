...
- (void)setLocalizationImagesGroup:(NSArray *)localizationImagesGroup
{
    ...
    [self setImagesGroup:[NSMutableArray arrayWithArray:localizationImagesGroup]];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.contentMode = UIViewContentModeScaleAspectFill;// UIViewContentModeScaleToFill;
